...
communes_fm<- st_read("Fonds_de_carte/commune_francemetro_2021.shp", options = "ENCODING=WINDOWS-1252") %>% 
  select(code,libelle,surf)
# Import des population légales des communes en 2019
pop_com_2019 <- read_excel("Pop_legales_2019.xlsx")
...
dep_fm<- st_read("Fonds_de_carte/dep_francemetro_2021.shp", options = "ENCODING=WINDOWS-1252")
taux_pauvrete <- read_excel("Taux_pauvrete_2018.xlsx")
